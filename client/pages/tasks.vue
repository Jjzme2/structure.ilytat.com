...
const filteredListTasks = computed(() => {
    ...
    // ⚡ Bolt Optimization: Filter array before sorting to reduce N.
    // Sorting is O(N log N) and filtering is O(N). By filtering first,
    // we significantly reduce the size of the array passed to the sort algorithm.
