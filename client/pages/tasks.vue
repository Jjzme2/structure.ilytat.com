...
const filteredListTasks = computed(() => {
    ...
    // ⚡ Bolt Performance Optimization: Filter before sorting to reduce N.
    // Sorting is O(N log N) while filtering is O(N). Filtering out excluded
    // statuses first ensures the expensive sort runs on a smaller dataset.
