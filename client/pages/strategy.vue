...
// Pre-compute a map of tasks by KR for O(1) lookup in template loops
// Expected Impact: Reduces O(N * M) filtering during render to O(N) map generation + O(1) lookups
