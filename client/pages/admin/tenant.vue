...
// Tenant Doc
const tenantDocRef = computed(() => doc(db, 'companies', tenantId.value))
...
<template>
    <div class="max-w-4xl mx-auto space-y-8 pb-20 text-slate-200">
        
        <div v-if="!isAdmin" class="text-center py-20 bg-rose-500/10 rounded-3xl border border-rose-500/20 text-rose-300">
        ...
        <div v-else class="space-y-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-slate-400">Manage organization details for <span class="text-indigo-400 font-mono">{{ tenantId }}</span></p>
                </div>
            </div>
                ...
                <form @submit.prevent="saveTenant" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex gap-4 items-center">
                             <div class="h-12 w-12 rounded bg-slate-800 border border-slate-700 flex items-center justify-center overflow-hidden shrink-0">
                    ...
                    <div class="pt-4 flex items-center justify-between">
                        <span v-if="message" :class="message.includes('Error') ? 'text-rose-400' : 'text-emerald-400'" class="text-sm font-medium animate-pulse">
                            {{ message }}
                        </span>
                        <span v-else></span>
