  ...
  <div class="fixed bottom-6 right-6 z-[100] flex flex-col gap-3 pointer-events-none">
    <TransitionGroup name="toast">
      <div v-for="toast in toasts" :key="toast.id"
        ...
        <button @click="remove(toast.id)" aria-label="Close notification" class="text-slate-500 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 rounded-md">
          ✕
        </button>
      </div>
    </TransitionGroup>
