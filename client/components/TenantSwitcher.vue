...
<template>
  <button
    @click="toggleScope"
    class="relative group flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-800/50 border border-slate-700/50 hover:border-accent-primary/50 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-400 transition-all duration-300"
