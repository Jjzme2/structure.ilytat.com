...
export const useDaily = () => {
    ...
    const fetchDaily = async () => {
        ...
        try {
            ...
            // BOLT OPTIMIZATION: Moved tasksQuery into the Promise.all array to eliminate
            // sequential await, executing all 4 Firestore reads concurrently.
            // Expected Impact: Reduces TTFB/total load time for daily dashboard by ~10-30%
            // by removing network waterfall.
