...
export const useInbox = () => {
    ...
    const markAllRead = async () => {
        ...
        // Replaced Promise.all(parallel updates) with a single writeBatch.
        // Reduces network overhead from O(N) requests to O(1) request.
        // Important: Firestore batches are limited to 500 ops.
        // Here we chunk the unread messages in case of large backlogs.
        const chunkSize = 500
