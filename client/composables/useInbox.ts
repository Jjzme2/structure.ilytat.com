...
export const useInbox = () => {
    ...
    const markAllRead = async () => {
        ...
        // Optimization: Use writeBatch instead of Promise.all(updateDoc)
        // This combines multiple operations into a single network request,
        // drastically reducing latency and network overhead.

        // Chunk operations into sizes of 500 to adhere to Firestore batch limits
        const chunkSize = 500
