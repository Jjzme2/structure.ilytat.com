...
export const useInbox = () => {
    ...
    const markAllRead = async () => {
        ...
        // ⚡ Bolt: Use writeBatch to group multiple updateDoc calls into a single network request.
        // This is much faster and more efficient than Promise.all with individual updateDoc calls.
        const chunkSize = 500
