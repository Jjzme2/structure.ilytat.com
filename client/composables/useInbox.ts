...
export const useInbox = () => {
    ...
    const markAllRead = async () => {
        ...
        // OPTIMIZATION: Use writeBatch to combine multiple updates into a single network request
        // IMPACT: Reduces N network requests to 1 network request, decreasing overall latency
