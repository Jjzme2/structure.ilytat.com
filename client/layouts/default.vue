      ...
      <nav class="max-w-5xl w-full glass-nav rounded-2xl md:rounded-3xl px-4 md:px-5 transition-all duration-500"
        ...
        <div class="flex items-center justify-between h-full">
          ...
          <div class="hidden md:flex items-center gap-4">
            ...
            <button @click="isOpen = true" class="group flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-muted hover:text-text-primary glass-pill transition-all duration-300 cursor-pointer mr-2">
              ...
              <div class="flex items-center gap-0.5 opacity-40 group-hover:opacity-80 transition-opacity ml-1">
                <kbd class="min-w-[1.2em] px-1 py-0.5 rounded border border-current text-[10px] font-mono flex items-center justify-center">⌘</kbd>
                <kbd class="min-w-[1.2em] px-1 py-0.5 rounded border border-current text-[10px] font-mono flex items-center justify-center">K</kbd>
              </div>
            </button>
          </div>
              ...
              <div class="relative group hidden sm:block">
                ...
                <div
                  ...
                  <div class="px-4 py-3 border-b border-glass mb-1">
                    <p class="text-xs font-bold text-muted uppercase tracking-wider">Operator</p>
