...
describe('Download Security', () => {
  ...
  it('should allow valid keys (e.g., documents/users/uid/file.pdf)', async () => {
  ...
  it('should block IDOR attempts (accessing another user\'s file)', async () => {
    ...
    try {
      ...
      expect(error.statusMessage).toContain('Unauthorized to access this file')
    }
  })
})
