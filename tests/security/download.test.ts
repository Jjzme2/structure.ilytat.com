...
describe('Download Security', () => {
  ...
  it('should block cross-user access (IDOR)', async () => {
    ...
    try {
      ...
      expect(error.statusMessage).toContain('Forbidden: Access denied to this file')
    }
  })

  it('should allow access to legacy root documents', async () => {
