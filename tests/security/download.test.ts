...
describe('Download Security', () => {
  ...
  it('should allow valid keys belonging to the user (e.g., documents/users/test-user/file.pdf)', async () => {
  ...
  it('should allow legacy unscoped keys for backwards compatibility', async () => {
  ...
  it('should block valid keys belonging to another user (IDOR)', async () => {
