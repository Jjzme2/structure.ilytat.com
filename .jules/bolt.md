...
## 2026-06-03 - Firestore Batch Updates
**Learning:** When updating multiple documents (e.g., marking several messages as read), utilize writeBatch from 'firebase/firestore' instead of processing concurrent individual writes via Promise.all. This combines multiple operations into a single network request, drastically reducing latency and network overhead.
**Action:** Use writeBatch for multi-document updates in Firestore to minimize concurrent network requests and improve performance.
