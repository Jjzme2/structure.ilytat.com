...
## 2024-05-28 - Firestore Batch Writes
**Learning:** Using `Promise.all` for multiple concurrent document updates in Firestore creates unnecessary network overhead and latency.
**Action:** Utilize `writeBatch` from 'firebase/firestore' to combine multiple operations into a single network request.
